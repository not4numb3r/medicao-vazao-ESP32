...
const char* default_TOPICO_SUBSCRIBE = "/TEF/flux070/cmd"; // Tópico MQTT de escuta
const char* default_TOPICO_PUBLISH_1 = "/TEF/flux070/attrs"; // Tópico MQTT de envio de informações para Broker
const char* default_TOPICO_PUBLISH_2 = "/TEF/flux070/attrs/f"; // Tópico MQTT de envio de informações para Broker
const char* default_ID_MQTT = "fiware_070"; // ID MQTT
const int default_D4 = 2; // Pino do LED onboard
// Declaração da variável para o prefixo do tópico
const char* topicPrefix = "flux070";
